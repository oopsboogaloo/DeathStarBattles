...
export const STORY_MISSIONS = [
...

  {
    ...
    layout: {
      planets: [
        { type: 'asteroid', x: 0.35, y: 0.35, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.50, y: 0.60, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.65, y: 0.35, radius: 10, density: 80 },
      ],
      stations: [
...

  {
    ...
    layout: {
      planets: [
        ...
        { type: 'star', x: 0.50, y: 1.08, radius: 80, density: 600 },
      ],
      stations: [
...

  {
    ...
    layout: {
      planets: [
        { type: 'asteroid', x: 0.40, y: 0.30, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.55, y: 0.35, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.75, y: 0.40, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.50, y: 0.60, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.70, y: 0.65, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.85, y: 0.55, radius: 10, density: 80 },
      ],
      stations: [
...

  {
    ...
    layout: {
      planets: [
        ...
        { type: 'asteroid', x: 0.28, y: 0.40, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.36, y: 0.44, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.44, y: 0.40, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.50, y: 0.46, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.56, y: 0.40, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.64, y: 0.44, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.72, y: 0.40, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.30, y: 0.52, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.38, y: 0.56, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.46, y: 0.52, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.52, y: 0.58, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.58, y: 0.52, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.66, y: 0.56, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.74, y: 0.52, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.42, y: 0.60, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.60, y: 0.60, radius: 10, density: 80 },
      ],
      stations: [
...

  {
    ...
    layout: {
      planets: [
        // Central star
        { type: 'star', x: 0.50, y: 0.50, radius: 22, density: 200 },
        // Asteroid ring at roughly 25–35% of map radius from centre
        { type: 'asteroid', x: 0.50, y: 0.20, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.60, y: 0.22, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.69, y: 0.28, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.76, y: 0.36, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.78, y: 0.47, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.75, y: 0.58, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.68, y: 0.67, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.59, y: 0.73, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.49, y: 0.76, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.39, y: 0.73, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.30, y: 0.67, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.23, y: 0.58, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.20, y: 0.47, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.23, y: 0.36, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.30, y: 0.28, radius: 9, density: 80 },
        { type: 'asteroid', x: 0.39, y: 0.22, radius: 8, density: 80 },
        { type: 'asteroid', x: 0.55, y: 0.24, radius: 7, density: 80 },
        { type: 'asteroid', x: 0.64, y: 0.32, radius: 7, density: 80 },
        { type: 'asteroid', x: 0.70, y: 0.42, radius: 7, density: 80 },
        { type: 'asteroid', x: 0.67, y: 0.62, radius: 7, density: 80 },
        { type: 'asteroid', x: 0.44, y: 0.26, radius: 7, density: 80 },
        { type: 'asteroid', x: 0.27, y: 0.44, radius: 7, density: 80 },
      ],
      stations: [
        { x: 0.10, y: 0.30, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.10, y: 0.46, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.10, y: 0.62, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.10, y: 0.78, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.90, y: 0.30, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.90, y: 0.46, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.90, y: 0.62, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.90, y: 0.78, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
      ],
    },
...

  {
    ...
    layout: {
      planets: [
        { type: 'gasGiant', x: 0.50, y: 0.50, radius: 32, density: 40 },
        { type: 'asteroid', x: 0.28, y: 0.30, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.42, y: 0.22, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.60, y: 0.20, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.74, y: 0.32, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.80, y: 0.48, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.78, y: 0.65, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.64, y: 0.76, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.46, y: 0.80, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.28, y: 0.70, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.22, y: 0.54, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.35, y: 0.62, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.68, y: 0.36, radius: 10, density: 80 },
      ],
      stations: [
...

  {
    ...
    layout: {
      planets: [
        { type: 'gasGiant', x: 0.48, y: 0.52, radius: 28, density: 40 },
        { type: 'asteroid', x: 0.24, y: 0.28, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.38, y: 0.18, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.56, y: 0.22, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.72, y: 0.30, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.82, y: 0.44, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.80, y: 0.62, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.70, y: 0.76, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.52, y: 0.82, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.34, y: 0.76, radius: 10, density: 80 },
        { type: 'asteroid', x: 0.22, y: 0.62, radius: 12, density: 80 },
        { type: 'asteroid', x: 0.20, y: 0.44, radius: 14, density: 80 },
        { type: 'asteroid', x: 0.62, y: 0.38, radius: 10, density: 80 },
      ],
      stations: [
        { x: 0.12, y: 0.42, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.12, y: 0.58, team: 0, role: 'human', visualStyle: 'station' },
    ...
    events: [
      {
        turn: 3,
        spawnStations: [
          { x: null, y: null, team: 1, role: 'ai', visualStyle: 'drone', aiLevel: 3, startingWeapons: { rocket: 99 } },
          { x: null, y: null, team: 1, role: 'ai', visualStyle: 'drone', aiLevel: 3, startingWeapons: { rocket: 99 } },
        ],
    ...
    events: [
      {
        turn: 2,
        spawnStations: [
          { x: null, y: null, team: 1, role: 'ai', visualStyle: 'drone', aiLevel: 3, startingWeapons: { tripleCannon: 4 } },
          { x: null, y: null, team: 1, role: 'ai', visualStyle: 'drone', aiLevel: 3, startingWeapons: { tripleCannon: 4 } },
          { x: null, y: null, team: 1, role: 'ai', visualStyle: 'drone', aiLevel: 3, startingWeapons: { tripleCannon: 4 } },
          { x: null, y: null, team: 1, role: 'ai', visualStyle: 'drone', aiLevel: 3, startingWeapons: { tripleCannon: 4 } },
        ],
...

  {
    ...
    layout: {
      ...
      stations: [
        ...
        { x: 0.88, y: 0.25, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.88, y: 0.35, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.88, y: 0.45, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.88, y: 0.55, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.88, y: 0.65, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.88, y: 0.75, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
      ],
    },
...

  {
    ...
    layout: {
      ...
      stations: [
        ...
        { x: 0.12, y: 0.50, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.12, y: 0.65, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.78, y: 0.20, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.85, y: 0.32, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.80, y: 0.44, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.80, y: 0.58, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.85, y: 0.70, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
        { x: 0.78, y: 0.82, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 3 },
      ],
    },
...

  {
    ...
    layout: {
      ...
      stations: [
        { x: 0.15, y: 0.42, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.15, y: 0.58, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.85, y: 0.42, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.85, y: 0.58, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.42, y: 0.12, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.58, y: 0.12, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.42, y: 0.88, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.58, y: 0.88, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
      ],
    },
...

  {
    ...
    layout: {
      ...
      stations: [
        ...
        { x: 0.12, y: 0.50, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.10, y: 0.62, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.90, y: 0.38, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.88, y: 0.50, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.90, y: 0.62, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.38, y: 0.10, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.50, y: 0.12, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.62, y: 0.10, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.38, y: 0.90, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.50, y: 0.88, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.62, y: 0.90, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.22, y: 0.32, team: 4, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.28, y: 0.42, team: 4, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.22, y: 0.52, team: 4, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.78, y: 0.48, team: 5, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.72, y: 0.58, team: 5, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
        { x: 0.78, y: 0.68, team: 5, role: 'ai',    visualStyle: 'drone',   aiLevel: 4 },
      ],
    },
...

  {
    ...
    layout: {
      ...
      stations: [
        ...
        { x: 0.92, y: 0.30, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.90, y: 0.42, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.92, y: 0.58, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.90, y: 0.70, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.30, y: 0.08, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.42, y: 0.10, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.58, y: 0.08, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.70, y: 0.10, team: 2, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.30, y: 0.92, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.42, y: 0.90, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.58, y: 0.92, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.70, y: 0.90, team: 3, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.18, y: 0.18, team: 4, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.24, y: 0.26, team: 4, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.20, y: 0.34, team: 4, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.28, y: 0.22, team: 4, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.82, y: 0.18, team: 5, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.76, y: 0.26, team: 5, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.80, y: 0.34, team: 5, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.72, y: 0.22, team: 5, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.18, y: 0.82, team: 6, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.24, y: 0.74, team: 6, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.20, y: 0.66, team: 6, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.28, y: 0.78, team: 6, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.82, y: 0.82, team: 7, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.76, y: 0.74, team: 7, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.80, y: 0.66, team: 7, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.72, y: 0.78, team: 7, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
      ],
    },
...

  {
    ...
    layout: {
      ...
      stations: [
        ...
        { x: 0.88, y: 0.28, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.88, y: 0.42, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.88, y: 0.58, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
        { x: 0.88, y: 0.72, team: 1, role: 'ai',    visualStyle: 'drone',   aiLevel: 5 },
      ],
    },
