...
export const STORY_MISSIONS = [
...

  {
    ...
    layout: {
      planets: [
        ...
        { type: 'star', x: 0.50, y: 1.08, radius: 80, density: 0.625 },
      ],
      stations: [
...

  {
    ...
    layout: {
      planets: [
        { type: 'gasGiant', x: 0.50, y: 0.50, radius: 32, density: 0.02 },
        { type: 'asteroid', x: 0.28, y: 0.30, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.42, y: 0.22, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.60, y: 0.20, radius: 10, density: 0.08 },
        { type: 'asteroid', x: 0.74, y: 0.32, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.80, y: 0.48, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.78, y: 0.65, radius: 10, density: 0.08 },
        { type: 'asteroid', x: 0.64, y: 0.76, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.46, y: 0.80, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.28, y: 0.70, radius: 10, density: 0.08 },
        { type: 'asteroid', x: 0.22, y: 0.54, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.35, y: 0.62, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.68, y: 0.36, radius: 10, density: 0.08 },
      ],
      stations: [
...

  {
    ...
    layout: {
      planets: [
        { type: 'gasGiant', x: 0.48, y: 0.52, radius: 28, density: 0.02 },
        { type: 'asteroid', x: 0.24, y: 0.28, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.38, y: 0.18, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.56, y: 0.22, radius: 10, density: 0.08 },
        { type: 'asteroid', x: 0.72, y: 0.30, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.82, y: 0.44, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.80, y: 0.62, radius: 10, density: 0.08 },
        { type: 'asteroid', x: 0.70, y: 0.76, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.52, y: 0.82, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.34, y: 0.76, radius: 10, density: 0.08 },
        { type: 'asteroid', x: 0.22, y: 0.62, radius: 12, density: 0.08 },
        { type: 'asteroid', x: 0.20, y: 0.44, radius: 14, density: 0.08 },
        { type: 'asteroid', x: 0.62, y: 0.38, radius: 10, density: 0.08 },
      ],
      stations: [
        { x: 0.12, y: 0.42, team: 0, role: 'human', visualStyle: 'station' },
        { x: 0.12, y: 0.58, team: 0, role: 'human', visualStyle: 'station' },
