...
export const WEAPON_GRANTS = [
  ...
  { id: WeaponId.SEPTUPLE_CANNON,    charges: 1, label: 'SEPT. CANNON',    tier: 2 },
  { id: WeaponId.FRAGMENTATION_SHOT, charges: 1, label: 'FRAG SHOT',       tier: 2 },
  { id: WeaponId.SHOTGUN,            charges: 1, label: 'SHOTGUN',         tier: 2 },
  { id: WeaponId.DUAL_BLASTER,       charges: 1, label: 'DUAL BLASTER',    tier: 2 },
  ...
  { id: WeaponId.REPULSOR_FIELD,     charges: 1, label: 'REPULSOR FIELD',  tier: 2 },
