...
35 named scenarios control how planets are placed and what types appear. A "lucky dip" option picks randomly, weighted towards the more common scenarios:
- **25% chance** — picks from scenarios 1–6 (Planetary through Jovian)
- **63% chance** — picks from scenarios 1–19 (common + uncommon range)
- **12% chance** — picks from the full 1–35 pool
